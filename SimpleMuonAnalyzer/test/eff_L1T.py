...
if dataset==1: out_file  = TFile('Histograms.root','recreate')
else: out_file  = TFile('Histograms_MC.root','recreate')
############################################
...
if plot_efficiency == True:
  if dataset==1: print colored('Efficiency plots written to Histograms.root', 'green')
  else: print colored('Efficiency plots written to Histograms_MC.root', 'green')
...
if plot_kinematics == True:
  if dataset==1: print colored('Kinematic plots written to Histograms.root', 'green')
  else: print colored('Kinematic plots written to Histograms_MC.root', 'green')
